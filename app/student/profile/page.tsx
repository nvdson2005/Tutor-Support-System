...
// Component con hiển thị thông tin từng dòng
...
// Component con hiển thị thẻ chỉ số (GPA/Credits)
const StatCard = ({ label, value, colorClass }: { label: string, value: string, colorClass: string }) => (
  <div className={`flex flex-col items-center justify-center px-5 py-4 rounded-2xl ${colorClass} text-white shadow-sm min-w-[110px]`}>
    <span className="text-3xl font-bold">{value}</span>
    <span className="text-xs font-semibold opacity-90 uppercase mt-1">{label}</span>
  </div>
);
              ...
              <div className="px-8 pb-10 relative">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-end -mt-12 mb-8 gap-6">
                  ...
                  <div className="flex-1 text-center md:text-left mb-2 md:mb-1">
                    <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Student Name</h1>
                    <div className="flex items-center justify-center md:justify-start gap-3 mt-2 text-gray-600">
                      <span className="bg-blue-100 text-blue-800 text-xs px-2.5 py-0.5 rounded border border-blue-200 font-bold tracking-wide">STUDENT</span>
                      <span className="text-sm">ID: <span className="text-black font-bold font-mono text-base">2313862</span></span>
                    </div>
                  </div>
